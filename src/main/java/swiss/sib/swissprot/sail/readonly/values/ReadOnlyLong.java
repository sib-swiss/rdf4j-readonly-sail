...
public record ReadOnlyLong(long value) implements Literal, ReadOnlyValue {
	private static final long serialVersionUID = 1L;

	public static ReadOnlyLong fromLong(long l) {
		return new ReadOnlyLong(l);
	}

	public static long toLong(Literal rogy) {
		return rogy.longValue();
	}
	...
	public boolean equals(Object o) {
		...
		if (o instanceof ReadOnlyLong) {
			return value == ((ReadOnlyLong) o).value;
		}
